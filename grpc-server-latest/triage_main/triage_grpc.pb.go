...
type MessageHandlerClient interface {
	GetMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*MessageResponse, error)
}
...
func (c *messageHandlerClient) GetMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*MessageResponse, error) {
	out := new(MessageResponse)
	err := c.cc.Invoke(ctx, "/triage.MessageHandler/GetMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MessageHandlerServer interface {
	GetMessage(context.Context, *Message) (*MessageResponse, error)
...
func (UnimplementedMessageHandlerServer) GetMessage(context.Context, *Message) (*MessageResponse, error) {
...
func _MessageHandler_GetMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MessageHandlerServer).GetMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/triage.MessageHandler/GetMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageHandlerServer).GetMessage(ctx, req.(*Message))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _MessageHandler_GetMessage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "triage_main/triage.proto",
}
